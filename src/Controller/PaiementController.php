...
class PaiementController extends Controller
{
    ...
    {
        return $this->render('paiement/index.html.twig', ['paiements' => $paiementRepository->findAll()]);
    }
    ...
    {
        return $this->render('paiement/show.html.twig', ['paiement' => $paiement]);
    }
    ...
    public function edit(Request $request, Paiement $paiement): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('paiement_edit', ['id' => $paiement->getId()]);
        }
